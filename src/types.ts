...
export type Overwrite<TBase, TOverride> = Omit<TBase, keyof TOverride> &
    TOverride;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export type Constructable = new (...args: any[]) => unknown;
export type Args<T> = T extends Constructable
...
export type SxiObject<
    TContext extends object,
    TSource extends Constructable,
> = InstanceType<TSource> & SxiObjectMetadata<TContext, TSource>;
